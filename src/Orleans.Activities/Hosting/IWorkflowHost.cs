...
namespace Orleans.Activities.Hosting
{
    ...
    public interface IWorkflowHostControl
    {
        ...
        /// <summary>
        /// Optional, can be null.
        /// Always set the value in the ctor to a lambda or to an instance method and never set the value together with the OnStart property in the first incoming public grain method call that creates/starts the grain!
        ...
        /// Certainly call it only after OnStart property is set.
        ...
        /// Certainly call it only after OnStart property is set.
        /// It combines <see cref="WorkflowHost.OnCompletedAsync"/> and <see cref="WorkflowHost.RunAsync"/> in a special way, that RunToCompletion returns only when the workflow is completed or aborted.
        /// The ReceiveRequest activity shouldn't be the absolute first activity to start the workflow and to skip this method to use, this method is for the situation,
