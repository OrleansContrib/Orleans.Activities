...
namespace Orleans.Activities.Samples.Arithmetical.GrainImplementations
{
    ...
    public sealed class MultiplierGrain : WorkflowGrain<MultiplierGrain, WorkflowState>, IMultiplierGrain
    {
        ...
        public MultiplierGrain(ILogger<MultiplierGrain> logger)
        ...
        async Task IMultiplierGrain.MultiplyAsync(int arg1, int arg2)
        {
            ...
            {
                { nameof(MultiplierActivity.Arg1), arg1 },
                { nameof(MultiplierActivity.Arg2), arg2 },
            });

            await this.WorkflowControl.RunAsync();
        }
        ...
        public override async Task OnActivateAsync()
        {
            ...
            this.subsManager = new ObserverSubscriptionManager<IMultiplierResultReceiver>();
        }

        Task IMultiplierGrain.SubscribeAsync(IMultiplierResultReceiver observer)
        {
            this.subsManager.Subscribe(observer);
            return Task.CompletedTask;
        }
